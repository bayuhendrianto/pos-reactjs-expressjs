...
class MidtranNotificationClass {
  constructor(model) {
    model = model || {};
...
class ResponseRequestClass {
  constructor(model) {
    ...
    this.permata_va_number = model.permata_va_number || null;
    this.va_numbers = model.va_numbers
      ? JSON.parse(model.va_numbers)
      : model.va_numbers;
    this.payment_amounts = model.payment_amounts
      ? JSON.parse(model.payment_amounts)
...
class MidtranNotificationClassList extends List {
  get model() {
    return ResponseRequestClass;
  }
}

module.exports = {
  MidtranNotificationClass,
  MidtranNotificationClassList,
  ResponseRequestClass
};
